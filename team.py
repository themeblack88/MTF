...
cl = LineClient(authToken='ExUEs3vFiYT093tdimA0.cU7Vh9+BNRiLvWYab/HZSa.ZUHBqb3gHWUan+mWVodBQhVH4oz3oakJCBH/rQSBDmU=')
ki = LineClient(authToken='Ex8kck1MdQ485v3t3Ny7.rl0l7acJ5xJ+o/KaNsvYrW.n/JyrK6YVfXQC6nXrfBiHB2Mj89g0KgvLWn/038VT3g=')
kk = LineClient(authToken='ExALG6yJnvBJGZE3tXO0.KcyycWz+k1aQlcUiAaADCa.4U6wP09njEV+xR0FScc0JnyAKL5cyjUheHmLj4z+3nE=')
kc = LineClient(authToken='ExbCIX0eYXmmjxS7gjs9.PfSDtx/Tem+uVvC+kgjrwq.PSqKM8KOR1GcSmM3AHEemMVNEByTqeLzUK+SXy/s38g=')
ka = LineClient(authToken='Exndhy5GpqekRDIe0dR2.fqLuPA1Qt15lDkUeB+QeCG.a006Cwjr8QrYGL5VKokq7Wr4ZngGQ3X0AK6rgecCIWg=')
kh = LineClient(authToken='ExSGa8M3cF3NqEa63iJ6.icqxFEOZ1GoDpNtE0acNvG.tJI/KM4TysnNycjpcfRhPqdH5r7+QnpSdWZIqX7iWlk=')
sw = LineClient(authToken='ExfNQPxvSgWAe7oECvGb.mEoWX0o+8PcXTCtmj8AqUW.cV+Iu3YyLxqbIIp8vaCZqhCEmEYv/8biN7qFyz9UicI=')
...
Bots = [mid,Amid,Bmid,Cmid,Dmid,Emid,Zmid] #Jangan Dirubah Fungsi
