...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"[ Family bots ]\n\n"+ma+"\nTotal「%s」Bots " %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to," [ List admin & staff bot ]\n\n◈╾ Owner:\n"+ma+"\n◈╾ Admin:\n"+mb+"\n◈╾ Staff:\n"+mc+"\nTotal「%s」◈ Family ◈" %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"◈[ List protection groups ]◈\n\n◈╾  Protect url:\n"+ma+"\n◈╾  Protect kick:\n"+mb+"\n◈╾  Protect join:\n"+md+"\n◈╾  Protect cancel:\n"+mc+"\nTotal「%s」◈╾ List Protect Group ◈╾ " %(str(len(protectqr)+len(protectkick)+len(protectjoin)+len(protectcancel))))
