...
nadya = LINE()
nadya = LINE("ErjsLDwgCo9BfkUInQd0.Ms8E/+B4HzOoKu6F09UEya.UXK7FRKZc86jnhxEDlKICZtGBe8lW2eJ6E4MsyRbOzs=")
...
oepoll = OEPoll(nadya)
nadyaBot=[nadyaMID]
nadyaMID=["u992f1efbf6f8859a0e914e9fd3db9e60"]
#==============================================================================#
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                nadya.sendMessage(msg.to, "Berhasil ")
                                settings['copy'] = False
                                break
                            except:
